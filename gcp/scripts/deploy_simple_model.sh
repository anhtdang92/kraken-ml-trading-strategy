...
class SimpleStockModel:
    ...
    def __init__(self):
        ...
        self.supported_symbols = ['AAPL', 'MSFT', 'GOOGL', 'AMZN', 'NVDA', 'META', 'TSLA', 'SPY']
    ...
    def _create_default_prediction(self, symbol: str) -> Dict:
        ...
        # Mock current prices
        mock_prices = {
            'AAPL': 230.0, 'MSFT': 430.0, 'GOOGL': 175.0, 'AMZN': 200.0,
            'NVDA': 140.0, 'META': 530.0, 'TSLA': 250.0, 'SPY': 530.0,
        }
...
if __name__ == "__main__":
    ...
    test_data = {
        ...
        'lookback_data': {
            'AAPL': [
                [225, 228, 224, 227, 50000000],
                [227, 230, 226, 229, 52000000],
                [229, 232, 228, 231, 48000000],
                [231, 234, 230, 233, 55000000],
                [233, 236, 232, 235, 51000000],
                [235, 238, 234, 237, 49000000],
                [237, 240, 236, 239, 53000000]
            ],
            'MSFT': [
                [420, 425, 418, 423, 25000000],
                [423, 428, 421, 426, 27000000],
                [426, 431, 424, 429, 24000000],
                [429, 434, 427, 432, 28000000],
                [432, 437, 430, 435, 26000000],
                [435, 440, 433, 438, 25000000],
                [438, 443, 436, 441, 27000000]
            ]
        }
    }
